...
const AuthController = {
    ...
    async register(req, res) {
        try {
            ...
            // Generate the verification code and expiry time
            const verificationCode = generateVerificationCode();
            const expiresAt = new Date(Date.now() + 24 * 60 * 60 * 1000); // 1 day expiration

            // Create a new user with email verification details
            const user = new User({
                name,
                email,
            ...
            // Send the verification email (you need to implement this function)
    ...
    async resendVerificationEmail(req, res) {
        try {
            ...
            const expiresAt = new Date(now + 24 * 60 * 60 * 1000); // 1 day expiry
